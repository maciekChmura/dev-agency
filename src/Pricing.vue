  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-4xl text-center">
        <!--        <h2 class="  text-indigo-600">Simple fixed pricing</h2>-->
        <h2 class="mt-2 text-balance text-5xl tracking-tight text-gray-900 sm:text-6xl">Simple fixed pricing</h2>
      </div>
      <p class="mx-auto mt-6 max-w-2xl  text-center text-lg font-medium text-gray-600 sm:text-xl/8">100% custom MVP
        built for
        you</p>
      ...
      <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        <div v-for="tier in tiers" :key="tier.id"
          ...
          <h3 :id="tier.id" :class="[tier.featured ? 'text-white' : 'text-gray-900', 'text-lg/8 font-semibold']">
            {{ tier.name }}</h3>
